...
function w(t, n, e) {
    ...
    if (arguments.length > 2 && (u.children = arguments.length > 3 ? l.call(arguments, 2) : e),
...
function x(t, n, e, r, o) {
    ...
    return null == o && null != c.vnode && c.vnode(i),
        i;
}
...
function C(t, n) {
    if (null == n)
        return t.__ ? C(t.__, t.__.__k.indexOf(t) + 1) : null;
...
function E(t) {
    (!t.__d && (t.__d = !0) && d.push(t) && !I.__r++ || h !== c.debounceRendering) && ((h = c.debounceRendering) || setTimeout)(I);
}
    ...
    for (var t; I.__r = d.length;)
        ...
        t.some(function (t) {
            ...
            t.__d && (i = (o = (n = t).__v).__e,
                (u = n.__P) && (e = [],
                    (r = y({}, o)).__v = o.__v + 1,
                    F(u, o, r, n.__n, void 0 !== u.ownerSVGElement, null != o.__h ? [i] : null, e, null == i ? C(o) : i, o.__h),
                    O(e, o),
                    o.__e != i && P(o)));
        });
}
...
function T(t, n, e, r, o, i, u, s, a, l) {
    var c, f, p, d, h, _, g, y = r && r.__k || v,
        b = y.length;
    for (e.__k = [],
        c = 0; c < n.length; c++)
        if (null != (d = e.__k[c] = null == (d = n[c]) || "boolean" == typeof d ? null : "string" == typeof d || "number" == typeof d || "bigint" == typeof d ? x(null, d, null, null, d) : Array.isArray(d) ? x(S, {
                children: d
            }, null, null, null) : d.__b > 0 ? x(d.type, d.props, d.key, d.ref ? d.ref : null, d.__v) : d)) {
            if (d.__ = e,
                d.__b = e.__b + 1,
            ...
            F(t, d, p = p || m, o, i, u, s, a, l),
                ...
                null != h ? (null == _ && (_ = h),
                    ...
                    "function" == typeof e.type && (e.__d = a)) : a && p.__e == a && a.parentNode != t && (a = C(p));
        }
    for (e.__e = _,
        c = b; c--;)
        null != y[c] && W(y[c], y[c]);
...
function H(t, n, e) {
    "-" === n[0] ? t.setProperty(n, e) : t[n] = null == e ? "" : "number" != typeof e || g.test(n) ? e : e + "px";
}
...
function F(t, n, e, r, o, i, u, s, a) {
    var l, f, p, d, h, _, m, v, g, b, w, x, k, C, P, E = n.type;
    ...
    try {
        t: if ("function" == typeof E) {
            if (v = n.props,
                ...
                e.__c ? m = (f = n.__c = e.__c).__ = f.__E : ("prototype" in E && E.prototype.render ? n.__c = f = new E(v, b) : (n.__c = f = new N(v, b),
                        f.constructor = E,
                        f.render = B),
                    g && g.sub(f),
                    f.props = v,
                ...
                null != E.getDerivedStateFromProps && (f.__s == f.state && (f.__s = y({}, f.__s)),
                ...
                if (null == E.getDerivedStateFromProps && v !== d && null != f.componentWillReceiveProps && f.componentWillReceiveProps(v, b),
                    !f.__e && null != f.shouldComponentUpdate && !1 === f.shouldComponentUpdate(v, f.__s, b) || n.__v === e.__v) {
                    for (f.props = v,
                        f.state = f.__s,
                        n.__v !== e.__v && (f.__d = !1),
                        f.__v = n,
            ...
            null == i && n.__v === e.__v ? (n.__k = e.__k,
                n.__e = e.__e) : n.__e = R(e.__e, n, e, r, o, i, u, a);
        (l = c.diffed) && l(n);
    }
    catch (t) {
        n.__v = null,
...
function R(t, n, e, r, o, i, u, s) {
    ...
    if (null === h)
        ...
        if (function (t, n, e, r, o) {
            ...
            T(t, Array.isArray(_) ? _ : [_], n, e, r, o && "foreignObject" !== h, i, u, i ? i[0] : e.__k && C(e, 0), s),
            null != i)
            for (_ = i.length; _--;)
                null != i[_] && b(i[_]);
...
function q(t, n, e) {
    ...
    c.__ && c.__(t, n),
        ...
        i = [],
        F(n, t = (!r && e || n).__k = w(S, null, [t]), o || m, m, void 0 !== n.ownerSVGElement, !r && e ? [e] : o ? null : n.firstChild ? l.call(n.childNodes) : null, i, !r && e ? e : o ? o.__e : n.firstChild, r),
        O(i, t);
}
...
l = v.slice,
    ...
    N.prototype.setState = function (t, n) {
        var e;
        e = null != this.__s && this.__s !== this.state ? this.__s : this.__s = y({}, this.state),
...
function vt(t) {
    return at = 1,
        function (t, n, e) {
            var r = mt(rt++, 2);
            if (r.t = t,
                !r.__c && (r.__ = [Pt(void 0, n), function (t) {
...
c.__b = function (t) {
    ...
    c.diffed = function (t) {
        dt && dt(t);
        var n = t.__c;
        n && n.__H && (n.__H.__h.length && (1 !== lt.push(n) && ut === c.requestAnimationFrame || ((ut = c.requestAnimationFrame) || kt)(wt)),
...
var Mt = /*#__PURE__*/
    function (t) {
        ...
        r(e, t);
        var o = e.prototype;
        return o.validateProps = function () {
...
function Ot() {
    ...
    }, w(S, null, o && k > 0 && w("div", {
        role: "status",
        "aria-live": "polite",
        className: et(nt("summary"), t.className.paginationSummary),
        title: C("pagination.navigate", y + 1, E())
    }, C("pagination.showing"), " ", w("b", null, C("" + (y * p + 1))), " ", C("pagination.to"), " ", w("b", null, C("" + Math.min((y + 1) * p, k))), " ", C("pagination.of"), " ", w("b", null, C("" + k)), " ", C("pagination.results"))), w("div", {
        className: nt("pages")
    }, a && w("button", {
        tabIndex: 0,
        role: "button",
    ...
    }, C("pagination.previous")), function () {
        if (c <= 0)
            return null;
        var n = Math.min(E(), c),
            e = Math.min(y, Math.floor(n / 2));
        return y + Math.floor(n / 2) >= E() && (e = n - (E() - y)),
            w(S, null, E() > n && y - e > 0 && w(S, null, w("button", {
                tabIndex: 0,
                role: "button",
                onClick: function () {
                    return I(0);
...
function $t(t) {
    ...
    if (t.pluginId) {
        ...
        return o ? w(S, {}, w(o.component, e({
            plugin: o
        }, t.props))) : null;
    }
    return void 0 !== t.position ? w(S, {}, r.plugin.list(t.position).map(function (t) {
        return w(t.component, e({
            plugin: t
        }, n.props.props));
    })) : null;
}
var Gt = /*#__PURE__*/
    function (t) {
        function o() {
            var n;
            return (n = t.call(this) || this)._columns = void 0,
                n._columns = [],
                n;
        }
        r(o, t);
        var i = o.prototype;
        return i.adjustWidth = function (t, n, r) {
                var i = t.container,
                    u = t.autoWidth;
                if (!i)
                    return this;
                    ...
                    l = function (t) {
                        ...
                        var i = Array.from(n.parentNode.querySelectorAll("thead th")).reduce(function (t, n) {
                            ...
                            return n.style.width = n.clientWidth + "px",
                                e(((r = {})[n.getAttribute("data-column-id")] = {
                ...
                for (var c, f = s(o.tabularFormat(this.columns).reduce(function (t, n) {
                        return t.concat(n);
                    }, [])); !(c = f()).done;) {
                    var p = c.value;
                    p.columns && p.columns.length > 0 || (!p.width && u ? p.id in l && (p.width = Ut(l[p.id].width),
                        p.minWidth = Ut(l[p.id].minWidth)) : p.width = Ut(Rt(p.width, a)));
                }
                return n.current && u && q(null, r.current),
                    this;
            },
            i.setSort = function (t, n) {
                for (var r, o = s(n || this.columns || []); !(r = o()).done;) {
                    var i = r.value;
                    i.columns && i.columns.length > 0 ? i.sort = void 0 : void 0 === i.sort && t ? i.sort = {} : i.sort ? "object" == typeof i.sort && (i.sort = e({}, i.sort)) : i.sort = void 0,
            ...
            o.createFromConfig = function (t) {
                var n = new o();
                return t.from ? n.columns = o.fromHTMLTable(t.from).columns : t.columns ? n.columns = o.fromColumns(t.columns).columns : !t.data || "object" != typeof t.data[0] || t.data[0] instanceof Array || (n.columns = Object.keys(t.data[0]).map(function (t) {
                        return {
                            name: t
                        };
                    })),
            ...
            o.fromHTMLTable = function (t) {
                for (var n, e = new o(), r = s(t.querySelector("thead").querySelectorAll("th")); !(n = r()).done;) {
                    var i = n.value;
                    e.columns.push({
                        name: i.innerHTML,
                        width: i.width
    ...
    function () {
        ...
        return t.createFromConfig = function (t) {
            ...
            t.tableElementToArray = function (t) {
                for (var n, e, r = [], o = s(t.querySelector("tbody").querySelectorAll("tr")); !(n = o()).done;) {
...
var en = /*#__PURE__*/
    ...
    function () {
        ...
        return n.assign = function (t) {
            ...
            n.update = function (n) {
                return n ? (this.assign(t.fromPartialConfig(e({}, this, n))),
                    this) : this;
            },
            ...
            t.fromPartialConfig = function (n) {
                ...
                return "boolean" == typeof n.sort && n.sort && e.assign({
                        sort: {
                            multiColumn: !0
                        }
                    }),
                    e.assign({
                        header: Gt.createFromConfig(e)
                    }),
                    e.assign({
                        storage: Jt.createFromConfig(e)
                    }),
                    e.assign({
                        pipeline: an.createFromConfig(e)
                    }),
                    e.assign({
                        translator: new Tt(e.language)
                    }),
                    e.search && e.plugin.add({
                        id: "search",
                        position: qt.Header,
                        component: Dt
                    }),
                    e.pagination && e.plugin.add({
                        id: "pagination",
                        position: qt.Footer,
                        component: Ot
                    }),
...
function pn(t) {
    ...
    }, (n = t.column) ? "function" == typeof n.attributes ? n.attributes(t.cell.data, t.row, t.column) : n.attributes : {}), t.column && "function" == typeof t.column.formatter ? t.column.formatter(t.cell.data, t.row, t.column) : t.column && t.column.plugin ? w($t, {
...
function _n() {
    ...
    }), e === a.Loading && (!n || 0 === n.length) && w(hn, {
        message: o("loading"),
        colSpan: i(),
        className: et(nt("loading"), t.className.loading)
    }), e === a.Rendered && n && 0 === n.length && w(hn, {
...
var mn = /*#__PURE__*/
        ...
        return o.validateProps = function () {
            ...
            o.compareWrapper = function (t, n) {
                for (var e, r = 0, o = s(this.props.columns); !(e = o()).done;) {
                    ...
                    r |= "function" == typeof i.compare ? i.compare(u, a) * i.direction : this.compare(u, a) * i.direction;
                }
                return r;
            },
            o._process = function (t) {
    ...
    vn = function (t, n, r, o) {
        return function (i) {
            var u = i.sort ? [].concat(i.sort.columns) : [],
                ...
                f = !1,
                p = !1;
            if (void 0 !== a ? r ? -1 === a.direction ? f = !0 : p = !0 : 1 === s ? p = !0 : s > 1 && (c = !0,
                    l = !0) : 0 === s ? l = !0 : s > 0 && !r ? (l = !0,
                    c = !0) : s > 0 && r && (l = !0),
                c && (u = []),
                l)
                u.push({
    ...
    gn = function (t, n, r) {
        return function (o) {
            ...
            return e({}, o, i ? vn(t, 1 === i.direction ? -1 : 1, n, r)(o) : vn(t, 1, n, r)(o));
        };
    },
    yn = /*#__PURE__*/
    function (t) {
...
function bn(t) {
    ...
    var d = function () {
        ...
        return p && "object" == typeof p.server && (t = K.ServerSort),
            0 === n.pipeline.getStepsByType(t).length ? t === K.ServerSort ? new yn(e({
                columns: c ? c.columns : []
            }, p.server)) : new mn({
                columns: c ? c.columns : []
            }) : null;
...
function xn(t) {
    ...
    return w("th", e({
    ...
    }, void 0 !== t.column.name ? t.column.name : void 0 !== t.column.plugin ? w($t, {
        ...
        index: t.index
    }, t.column.sort)), t.column.resizable && t.index < n.header.visibleColumns.length - 1 && w(wn, {
        column: t.column,
        thRef: r
    }));
}
...
function kn() {
    ...
    return e ? w("thead", {
        ...
        return function (t, n, r) {
            ...
            return w(dn, null, t.map(function (t) {
...
function En() {
    ...
    gt(function () {
        ...
        gt(function () {
            t.header && r === a.Loaded && null != o && o.length && n(Sn(t.header.adjustWidth(t, i, u)));
        }, [o, t, u]);
    var s = function () {
        try {
            n(function (t) {
    ...
    return w("div", {
        role: "complementary",
        className: et("gridjs", nt("container"), r === a.Loading ? nt("loading") : null, t.className.container),
        style: e({}, t.style.container, {
            width: t.width
        })
    }, r === a.Loading && w("div", {
...
export {
    X as Cell, N as Component, fn as Config, In as Grid, qt as PluginPosition, Z as Row, nt as className, w as createElement, k as createRef, w as h, G as html, Et as useConfig, gt as useEffect, yt as useRef, jt as useSelector, vt as useState, Ht as useStore, Lt as useTranslator
};
